# Regras do projeto — oauth (VivaMente)
...
- Sempre passe por uma checagem de **segurança** antes de fechar a tarefa, validação de input, RBAC, dados sensíveis fora de log, endpoints públicos sem vazar dado interno (ver `docs/oauth.md`).

## Referência

- Especificação completa do projeto: `docs/oauth.md` (fonte da verdade) e `docs/oauth.txt` (lista curta de rotas).
